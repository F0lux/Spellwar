...
// Procedure qui permet de supprimer les marques de collision dans la zone de jeu grille
void supprimerMarqueCollision(Spellwar &grille);

/* Procedure qui permet d'executer l'action saisie pour le joueur du jeu spellwar
...
/* Procedure qui permet de faire jouer un arcaflamme du jeu spellwar
...
/* Permet d'afficher un message expliquant la raison de la fin de la partie du jeu spellwar
